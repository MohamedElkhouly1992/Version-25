...
with tabs[1]:
    ...
    with st.expander("Deadband fallback and monthly seasonal correction", expanded=False):
        ...
        if zone_source == "Upload DesignBuilder zone/grid files":
            ...
            if db_zone_uploads:
                try:
                    ...
                    st.dataframe(zone_df.head(50), use_container_width=True)
